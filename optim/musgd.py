...
class MuSGD(Optimizer):
    def __init__(self, params, lr=1e-3, momentum=0.9, muon_momentum=0.95, weight_decay=0.0, nesterov=True):
        defaults = dict(lr=lr, momentum=momentum, muon_momentum=muon_momentum, 
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                if len(p.shape) >= 2:
                    ...
                    update.mul_(scale * 0.2) # RMS adjustment factor
